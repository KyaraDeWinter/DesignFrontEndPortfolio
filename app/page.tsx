...
export default function Home() {
  ...
  const durabilityImages = [
    ...
    { href: "/images/posterDuurzaamheidV1.png", width: 500, height: 500 },
  ];
  ...
  return (
    <main className="pt-20 w-full flex justify-center">
      <div className="grid grid-cols-2 w-3/5 p-0 gap-5">
        ...
        />
        <Card
          text="Sustainable Phone Usage at ROC Nijmegen| This is a project where I designed a poster and flyer to promote sustainable phone usage at the school. The design is made to be eye-catching and to provide all the necessary information about where to find further information. The colour palette is based on the school's theme. Like mentioned in the text above, there is a infosheet available where a collection of tips & tricks is collected and put together."
          images={durabilityImages}
        />
      </div>
    </main>
  );
